                    ...
                    <div class="col-md-6 border-end">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                <img src="img/enseignant.png" class="img-fluid rounded-circle border-secondary" style="width: 150px; height: 150px;" alt="Image de Profil">
                            </div>
                            <!-- Détails du Profil -->
                            <div class="col-md-8">
                                <h3 class="text-secondary"><%=enseignant.getPersonne().getNom()+" "+enseignant.getPersonne().getPrenom()%></h3>
                                <p><strong>Nom d'utulisateur :</strong> <%=enseignant.getUser().getUsername()%></p>
                                <p><strong>Adresse :</strong> <%=enseignant.getPersonne().getAdresse()%></p>
                                <p><strong>Email :</strong> <%=enseignant.getPersonne().getEmail()%></p>
                                <p><strong>Specialte :</strong><%=enseignant.getSpecialte()%></p>
                                <p><strong>Departement :</strong><%=enseignant.getDep().getNom()%></p>
