                    ...
                    <div class="col-md-6 border-end">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                <img src="img/technicien.png" class="img-fluid rounded-circle border-secondary" style="width: 150px; height: 150px;" alt="Image de Profil">
                            </div>
                            <!-- Détails du Profil -->
                            <div class="col-md-8">
                                <h3 class="text-secondary"><%=technicien.getPersonne().getNom().toUpperCase(Locale.ROOT)+" "+technicien.getPersonne().getPrenom().toUpperCase(java.util.Locale.ROOT)%></h3>
                                <p><strong>Nom d'utulisateur :</strong> <%=technicien.getUser().getUsername()%></p>
                                <p><strong>Adresse :</strong> <%=technicien.getPersonne().getAdresse()%></p>
                                <p><strong>Email :</strong> <%=technicien.getPersonne().getEmail()%></p>
