...
public class EnseignantController {
    ...
    public String EffectuerDemande(HttpServletRequest request , HttpSession session)
    {
        ...
        Ressource ressource = new Ressource(marque,numInventaire,prix,type);

        Enseignant enseignant = (Enseignant) session.getAttribute("enseignant");
        CollecteBesoin besoinn = collecteBesoinService.getBesoinById(besId);
        Besoin b = new Besoin(enseignant,ressource,besoinn);
        if ("ordinateur".equals(type)) {
            ...
            Ordinateur ordinateur = new Ordinateur(cpu,disqueDure,ecran,ram,ressource);
            enseignantService.EffectuerDemandeOrd(ressource,ordinateur, b);
            ...
            Imprimante imprimante = new Imprimante(resolution,vitesseImpression,ressource);
            enseignantService.EffectuerDemandeImp(ressource,imprimante , b);
        }
